...
public class GamePeriodUtils {
	...
	public static final int HUB_SENSOR_DELAY_SECONDS = 3;
	public static final int ACTIVE_HUB_TIME_AFTER_GAME_ENDS = GAME_DURATION_SECONDS + HUB_SENSOR_DELAY_SECONDS;
