...
public class Field {
	...
	public static final double MAX_HUB_X_VALUE = getHubMiddle().getX() + HUB_SIDE_LENGTH_METERS / 2;
	public static final double MIN_HUB_X_VALUE = getHubMiddle().getX() - HUB_SIDE_LENGTH_METERS / 2;
