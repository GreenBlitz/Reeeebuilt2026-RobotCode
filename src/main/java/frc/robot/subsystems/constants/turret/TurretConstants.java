...
public class TurretConstants {
	...
	static {
		FEEDBACK_CONFIGS.SensorToMechanismRatio = 70.0 / 1.0;
	...
	public static final Rotation2d MAX_POSITION = Rotation2d.fromDegrees(-15.23);
	public static final Rotation2d MIN_POSITION = Rotation2d.fromDegrees(44.77);
	public static final Rotation2d FORWARD_SOFTWARE_LIMIT = Rotation2d.fromDegrees(MAX_POSITION.getDegrees() - 2);
