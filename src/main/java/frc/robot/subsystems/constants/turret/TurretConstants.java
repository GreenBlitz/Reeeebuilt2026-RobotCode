...
public class TurretConstants {
	...
	public static final Rotation2d BACKWARDS_SOFTWARE_LIMIT = Rotation2d.fromDegrees(-110);
	public static final Rotation2d MIN_POSITION = Rotation2d.fromDegrees(-123);
	public static final Rotation2d MAX_POSITION = Rotation2d.fromDegrees(237);
