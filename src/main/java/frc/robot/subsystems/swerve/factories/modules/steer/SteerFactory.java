...
public class SteerFactory {
	...
	public static ControllableMotor createSteer(String logPath, ModuleUtil.ModulePosition modulePosition) {
		...
		return switch (modulePosition) {
			case FRONT_LEFT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_FRONT_LEFT_STEER, IDs.CANCoderIDs.SWERVE_FRONT_LEFT, true);
			case FRONT_RIGHT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_FRONT_RIGHT_STEER, IDs.CANCoderIDs.SWERVE_FRONT_RIGHT, true);
			case BACK_LEFT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_BACK_LEFT_STEER, IDs.CANCoderIDs.SWERVE_BACK_LEFT, true);
			case BACK_RIGHT ->
				KrakenX60SteerBuilder.buildSteer(logPath, IDs.TalonFXIDs.SWERVE_BACK_RIGHT_STEER, IDs.CANCoderIDs.SWERVE_BACK_RIGHT, true);
		};
	}
