...
public class KrakenX60FlyWheelBuilder {
	...
	public static FlyWheel build(String logPath, Phoenix6DeviceID motorID) {
		...
		Phoenix6Request<Rotation2d> velocityRequest = Phoenix6RequestBuilder.build(new VelocityVoltage(0), 0, false);
		Phoenix6Request<Double> voltageRequest = Phoenix6RequestBuilder.build(new VoltageOut(0), false);
