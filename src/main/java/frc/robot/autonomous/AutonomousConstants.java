...
public class AutonomousConstants {
	...
	public static final double TIME_TO_WAIT_TO_START_PASSING_AFTER_PUSH_AUTO_START = 1;
	public static final double TIME_TO_PASS_IN_PUSH_AUTO = 8;

	public static final double TIME_TO_WAIT_TO_START_PASSING_AFTER_HALF_SOLO_AUTO_START = 1;
	public static final double TIME_TO_PASS_IN_HALF_SOLO_AUTO = 6;
