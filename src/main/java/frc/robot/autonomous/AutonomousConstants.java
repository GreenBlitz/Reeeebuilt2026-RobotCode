...
public class AutonomousConstants {
	...
	public static final double TIME_TO_WAIT_TO_START_PASSING_AFTER_AUTO_START = 3.5;
	public static final double TIME_TO_WAIT_TO_START_SHOOTING_AFTER_PASSING = 6.0;
