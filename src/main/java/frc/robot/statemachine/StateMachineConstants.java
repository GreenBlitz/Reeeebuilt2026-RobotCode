...
public class StateMachineConstants {
	...
	public static final Rotation2d TURRET_LOOK_AT_HUB_TOLERANCE_TO_START_SCORING = Rotation2d.fromDegrees(3);
	public static final Rotation2d TURRET_LOOK_AT_HUB_TOLERANCE_TO_CONTINUE_SCORING = Rotation2d.fromDegrees(3);
