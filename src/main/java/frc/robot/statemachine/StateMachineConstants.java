...
public class StateMachineConstants {
	...
	public static final Rotation2d TURRET_LOOK_AT_HUB_TOLERANCE = Rotation2d.fromDegrees(3);
	...
	public static final double TIME_FOR_OMNI_TO_ACCELERATE_SECONDS = 0.05;
