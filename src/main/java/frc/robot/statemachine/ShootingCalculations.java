...
public class ShootingCalculations {
	...
	public static ShootingParams calculateShootingParams(
		...
		Translation2d turretPredictedPose = getPredictedTurretPose(turretFieldRelativeTranslation,turretFieldRelativeVelocity, turretToHubDistanceMeters);
		...
		Logger.recordOutput(LOG_PATH+ "/predictedTurretPose",
				new Pose2d(turretPredictedPose,new Rotation2d())
		);
