...
public class ShootingCalculations {
	...
	static {
		...
		FLYWHEEL_PASSING_INTERPOLATION_MAP.put(4.0, Rotation2d.fromDegrees(21000));
		FLYWHEEL_PASSING_INTERPOLATION_MAP.put(8.08, Rotation2d.fromDegrees(32000));
		FLYWHEEL_PASSING_INTERPOLATION_MAP.put(15.0, Rotation2d.fromDegrees(54000));
		...
		DISTANCE_TO_BALL_FLIGHT_TIME_INTERPOLATION_MAP.put(13.0, 2.5);
	}
