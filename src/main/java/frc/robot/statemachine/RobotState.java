...
public enum RobotState {
	...
	NEUTRAL,
	OUTTAKE,
	PRE_SCORE(SwerveState.DEFAULT_DRIVE.withAimAssist(AimAssist.NONE).withDriveSpeed(DriveSpeed.SHOOT)),
	SCORE(SwerveState.DEFAULT_DRIVE.withAimAssist(AimAssist.NONE).withDriveSpeed(DriveSpeed.SHOOT)),
