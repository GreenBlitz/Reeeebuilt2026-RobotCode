...
public enum FunnelState {
	...
	STOP,
	PRE_SHOOT(Rotation2d.fromRotations(70), -2, -2),
	SHOOT(Rotation2d.fromRotations(70), 8.4, 8.4),
	OUTTAKE(Rotation2d.fromRotations(Double.NaN), -8, -8),
	ROLL_UNTIL_SENSOR(Rotation2d.fromRotations(70), 4, 4),
	OUTTAKE_SHOOT(Rotation2d.fromRotations(70), -8, -8),
	CALIBRATION;
