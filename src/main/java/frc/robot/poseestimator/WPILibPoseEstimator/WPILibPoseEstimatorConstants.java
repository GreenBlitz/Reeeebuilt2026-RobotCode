...
public class WPILibPoseEstimatorConstants {
	...
	public static final double COLLISION_POSE_ESTIMATION_ERROR_MEASURE_ADDITION_FACTOR = 0;

	public static final double TILT_POSE_ESTIMATION_ERROR_MEASURE_ADDITION_FACTOR = 0;

	public static final double SKID_POSE_ESTIMATION_ERROR_MEASURE_ADDITION_FACTOR = 0;
