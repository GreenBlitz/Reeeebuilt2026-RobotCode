...
public class WPILibPoseEstimatorConstants {
	...
	public static final double COLLISION_ODOMETRY_DEPENDANT_POSE_ESTIMATION_ACCURACY_MEASURE_REDUCTION_FACTOR = 0;

	public static final double TILT_ODOMETRY_DEPENDANT_POSE_ESTIMATION_ACCURACY_MEASURE_REDUCTION_FACTOR = 0;

	public static final double SKID_ODOMETRY_DEPENDANT_POSE_ESTIMATION_ACCURACY_MEASURE_REDUCTION_FACTOR = 0;
	...
	public static double VALUE_ONE_COMPENSATED_VISION_STD_DEV_POSE_ESTIMATION_ACCURACY_MEASURE_ADDITION = 0.1;
