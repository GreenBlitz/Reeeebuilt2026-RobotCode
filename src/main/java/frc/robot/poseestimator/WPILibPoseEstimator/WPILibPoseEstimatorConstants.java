...
public class WPILibPoseEstimatorConstants {
	...
	public static final double COLLISION_ODOMETRY_CAUSED_POSE_ESTIMATION_ERROR_MEASURE_ADDITION = 0;

	public static final double TILT_ODOMETRY_CAUSED_POSE_ESTIMATION_ERROR_MEASURE_ADDITION = 0;
