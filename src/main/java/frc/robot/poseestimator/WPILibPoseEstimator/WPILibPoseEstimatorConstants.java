...
public class WPILibPoseEstimatorConstants {
	...
	public static final Rotation2d TILT_ROBOT_ROLL_TOLERANCE = Rotation2d.fromDegrees(4);

	public static final Rotation2d TILT_ROBOT_PITCH_TOLERANCE = Rotation2d.fromDegrees(4);
