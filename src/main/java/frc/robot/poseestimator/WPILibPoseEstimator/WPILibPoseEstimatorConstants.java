...
public class WPILibPoseEstimatorConstants {
	...
	public static final double COLLISION_POSE_ESTIMATION_ACCURACY_MEASURE_REDUCTION_FACTOR = 0;

	public static final double TILT_POSE_ESTIMATION_ACCURACY_MEASURE_REDUCTION_FACTOR = 0;

	public static final double SKID_POSE_ESTIMATION_ACCURACY_MEASURE_REDUCTION_FACTOR = 0;
