...
public class WPILibPoseEstimatorConstants {
	...
	public static final double VISION_OBSERVATION_COLLISION_CAUSED_ERROR_ADDITION = 0;

	public static final double VISION_OBSERVATION_TILTED_CAUSED_ERROR_ADDITION = 0;
