...
public class WPILibPoseEstimatorWrapper implements IPoseEstimator {
	...
	private double odometryCausedEstimatedPoseErrorMeasure;
	...
	public void log() {
		...
		Logger.recordOutput("/estimatedPoseErrorMeasure", odometryCausedEstimatedPoseErrorMeasure);
	}
	...
	private StandardDeviations2D getOdometryErrorCompensatedVisionStdDevs(StandardDeviations2D visionStd) {
		...
		double averageStdDevsXYOfCompensatedStdDevs = (compensatedStdDevs.xStandardDeviations() + compensatedStdDevs.yStandardDeviations()) / 2.0;
		if (
			this.odometryCausedEstimatedPoseErrorMeasure
				- odometryCausedEstimatedPoseErrorMeasure * (WPILibPoseEstimatorConstants.CONSTANT_TO_CALC_STD / averageStdDevsXYOfCompensatedStdDevs)
				> 1
		) {
